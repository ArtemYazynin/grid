...
export class ColumnConfig {
    ...
    $width: BehaviorSubject<number | string>;
    ...
    constructor(public dataField: string, children: ColumnConfig[], sticky: boolean, isVisible: boolean,
        ...
        width: number | string, height: number = 40, colspan = 1, rowspan = 1, order: number = 999, isStickyEnd: boolean = false,
        ...
        this.$width = new BehaviorSubject<number | string>(width);
